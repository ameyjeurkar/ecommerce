...
const Navbar = () => {
    return (
        <nav className="bg-[coral] text-black fixed z-20 top-0 start-0 border-b border-default left-0 right-0 box-border border mx-20">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between p-4">
            <a className="flex items-center space-x-3 rtl:space-x-reverse">
                <span className="self-center text-[1.5rem] text-heading font-bold whitespace-nowrap">SHOP<span className="text-white font-bold">CARTEL</span></span>
            </a>
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                <ul className="font-medium font-semibold flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
