            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                    <div className="border rounded-lg p-6 bg-black-700">
                        <Image src={product?.images[0]} width={400} height={400} alt={product?.description} className="w-full object-contain"/>
                    </div>
                ...
                <div className="flex items-center">
                    ...
                    <p className="ms-2 text-sm font-bold text-heading">{product?.rating}</p>
                    <span className="w-1 h-1 mx-1.5 bg-neutral-quaternary rounded-full"></span>
                    <Link href="#" className="text-sm font-medium text-heading underline hover:no-underline">{product?.reviews?.length} reviews</Link>
                </div>
                ...
                {
                    product.availabilityStatus.toUpperCase().replaceAll(" ", "_") === "IN_STOCK" ? (
